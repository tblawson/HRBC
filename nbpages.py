...
#        self.BuildComboChoices()
        ...
        gbSizer.Add(self.T2Dvms, pos=(5, 1), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(GMH1Lbl, pos=(6, 0), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(self.GMH1Probes, pos=(6, 1), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(GMH2Lbl, pos=(7, 0), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        ...
        gbSizer.Add(RNamesLbl, pos=(5, 4), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        # Filename
        gbSizer.Add(FileLbl, pos=(11, 0), span=(1, 1), flag=wx.ALL | wx.EXPAND,
                    border=5)
...
class RunPage(wx.Panel):
    def __init__(self, parent):
        ...
        gbSizer.Add(self.StopRow, pos=(6, 1), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(RowLbl, pos=(5, 2), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(self.Row, pos=(6, 2), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(TimeLbl, pos=(5, 3), span=(1, 2),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(self.Time, pos=(6, 3), span=(1, 2),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(VavLbl, pos=(5, 5), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(self.Vav, pos=(6, 5), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(VsdLbl, pos=(5, 6), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
