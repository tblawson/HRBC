...
class SetupPage(wx.Panel):
    def __init__(self, parent):
        ...
        self.COMAddressList = ['addresses', 'COM0']  # dummy values
        ...
        T2DvmLbl = wx.StaticText(self, label='R2 T-probe DVM (DVMT2):',
                                 id=wx.ID_ANY)
        ...
        GMH1Lbl = wx.StaticText(self, label='R1 GMH probe (GMH1):',
                                id=wx.ID_ANY)
        ...
        GMH2Lbl = wx.StaticText(self, label='R2 GMH probe (GMH2):',
                                id=wx.ID_ANY)
        ...
        SwitchboxLbl = wx.StaticText(self, label='Switchbox configuration:',
                                     id=wx.ID_ANY)
...
#                                  'switchbox': 'V1'}
        ...
        ResponseLbl = wx.StaticText(self, label='Instrument Test Response:',
                                    id=wx.ID_ANY)
        ...
        # Instruments
        gbSizer.Add(Src1Lbl, pos=(0, 0), span=(1, 1), flag=wx.ALL | wx.EXPAND,
                    border=5)
        gbSizer.Add(self.V1Sources, pos=(0, 1), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(Src2Lbl, pos=(1, 0), span=(1, 1), flag=wx.ALL | wx.EXPAND,
                    border=5)
        ...
        gbSizer.Add(self.T1Dvms, pos=(4, 1), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(T2DvmLbl, pos=(5, 0), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(self.T2Dvms, pos=(5, 1), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(GMH1Lbl, pos=(6, 0), span=(1, 1), flag=wx.ALL | wx.EXPAND,
                    border=5)
        gbSizer.Add(self.GMH1Probes, pos=(6, 1), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(GMH2Lbl, pos=(7, 0), span=(1, 1), flag=wx.ALL | wx.EXPAND,
                    border=5)
        gbSizer.Add(self.GMH2Probes, pos=(7, 1), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(GMHroomLbl, pos=(8, 0), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(self.GMHroomProbes, pos=(8, 1), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(SwitchboxLbl, pos=(9, 0), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(self.Switchbox, pos=(9, 1), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        # Addresses
        gbSizer.Add(self.V1SrcAddr, pos=(0, 2), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        ...
        gbSizer.Add(self.T2DvmAddr, pos=(5, 2), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(self.GMH1Ports, pos=(6, 2), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        ...
        gbSizer.Add(self.SwitchboxAddr, pos=(9, 2), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        # R Name
        gbSizer.Add(self.R1Name, pos=(6, 4), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(self.R2Name, pos=(7, 4), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(RNamesLbl, pos=(5, 4), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        # Filename
        gbSizer.Add(FileLbl, pos=(11, 0), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(self.XLFile, pos=(11, 1), span=(1, 5),
                    flag=wx.ALL | wx.EXPAND, border=5)
        # Test buttons
        gbSizer.Add(self.S1Test, pos=(0, 3), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        ...
        gbSizer.Add(self.DT2Test, pos=(5, 3), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(self.GMH1Test, pos=(6, 3), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(self.GMH2Test, pos=(7, 3), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        gbSizer.Add(self.GMHroomTest, pos=(8, 3), span=(1, 1),
                    flag=wx.ALL | wx.EXPAND, border=5)
        ...
        '''
        # Roles and corresponding comboboxes/test btns
        are associated here.
        'icb'=instrument combobox
        'acb'=address combobox,
        'tbtn'=test button.
        '''
...
Creating VISA device (%s -> %s).' % (d, r)
    ...
    def SetInstr(self, d, r):
        ...
        Updates internal info (INSTR_DATA) and Enables/disables testbuttons as
        necessary.
        """
...
Other notes may be added manually.'
        ...
        V1SrcLbl = wx.StaticText(self, id=wx.ID_ANY, style=wx.ALIGN_RIGHT,
                                 label='Set V1:')
        ...
        V2SrcLbl = wx.StaticText(self, id=wx.ID_ANY, style=wx.ALIGN_RIGHT,
                                 label='Set V2:')
        ...
        # Delay widgets
        SettleDelLbl = wx.StaticText(self, id=wx.ID_ANY,
                                     label='Settle delay:')
        self.SettleDel = wx.SpinCtrl(self, id=wx.ID_ANY, value='0', min=0,
                                     max=600)
        StartDelLbl = wx.StaticText(self, id=wx.ID_ANY,
                                    label='Start delay:')
        self.StartDel = wx.TextCtrl(self, id=wx.ID_ANY,
                                    style=wx.TE_READONLY)
